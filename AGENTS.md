...
- **A) The code does too much** for what the tests ask for. The coverage issue reveals behavior that no test requires. The fix is to simplify the implementation.
